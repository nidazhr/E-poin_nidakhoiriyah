...
<body>
  <div class="container">
    ...
    <form action="{{ route('pelanggaran.store') }}" method="POST">
      ...
      <textarea id="jenis" name="jenis" rows="7" cols="50" value="{{ old('jenis') }}"></textarea><br><br>

      <label>Konsekuensi</label><br>
      <textarea id="konsekuensi" name="konsekuensi" rows="7" cols="50" value="{{ old('konsekuensi') }}"></textarea><br><br>
